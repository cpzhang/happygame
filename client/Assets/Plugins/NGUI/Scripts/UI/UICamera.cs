...
public class UICamera : MonoBehaviour
{
    ...
    /// </summary>
    private static System.DateTime playerActiveTime = System.DateTime.Now; //玩家不活动的计时器
    public static double PlayerActiveTime
    {
        set
        {
            playerActiveTime = System.DateTime.Now;
        }
        get
        {
            return (System.DateTime.Now - playerActiveTime).TotalSeconds;
        }
    }
