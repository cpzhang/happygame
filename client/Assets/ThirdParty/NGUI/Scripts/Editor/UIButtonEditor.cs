...
{
    SerializedProperty click_effect_prop;
	...
	protected override void DrawProperties ()
	{
        ...
        if (click_effect_prop == null)
        {
            SerializedObject serObj = new SerializedObject(target);
            click_effect_prop = serObj.FindProperty("click_effect_");
        }
        if (click_effect_prop != null)
            EditorGUILayout.PropertyField(click_effect_prop, new GUIContent("Click Effect"));
